...
export const SEED_COMPANIES: (CreateCompanyInput & { slug: string })[] = [
  {
    ...
    defaultCurrency: "EUR",
    productsServices: ["Pilot-training enrolment with European flight-school partners"],
    targetAudiences: [
    ...
    targetMarkets: ["India", "Asia", "Middle East", "International"],
    primaryObjective:
    ...
    prohibitedClaims: ["Guaranteed airline job", "Cheapest pilot training"],
  ...
  },
  {
    ...
    targetAudiences: ["Pilot-training candidates", "Licensed pilots", "Aviation businesses"],
    targetMarkets: ["Global"],
    primaryObjective: "Be a premium global aviation career and service partner",
    description:
      "Aviation services and pilot training — a premium global aviation career/service partner.",
    brandPositioning: "Premium global aviation career/service partner",
    brandTone: "Premium, knowledgeable, direct",
    companyRules: [
  ...
  },
  {
    ...
    targetAudiences: ["Students seeking overseas education"],
    targetMarkets: ["India"],
    primaryObjective:
    ...
    brandPositioning: "Honest, personal overseas-education guidance",
...
export const SEED_APPROVALS: SeedApproval[] = [
  ...
  },
  {
    ...
    requestedAction: "Raise “Overseas Masters — Autumn Intake” ad set daily budget ₹400 → ₹650",
    explanation:
      "Development seed example: the increase exceeds the ₹100 automatic limit in Opportunitygrad's commercial rules, so it needs financial approval.",
    riskLevel: "high",
    beforeState: { dailyBudget: 400, currency: "INR" },
    afterState: { dailyBudget: 650, currency: "INR" },
    minutesAgo: 9,
  },
  {
    company: EPT,
